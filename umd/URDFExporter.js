(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('three'), require('three/examples/js/loaders/STLExporter'), require('three/examples/js/loaders/ColladaExporter')) :
    typeof define === 'function' && define.amd ? define(['three', 'three/examples/js/loaders/STLExporter', 'three/examples/js/loaders/ColladaExporter'], factory) :
    (global.URDFExporter = factory(global.THREE,global.THREE,global.THREE));
}(this, (function (THREE,STLExporter,ColladaExporter) { 'use strict';
    ...
    class URDFExporter {
        ...
        get STLExporter() {
            ...
            return this._stlExporter = this._stlExporter || new STLExporter.STLExporter();

        }

        get ColladaExporter() {

            return this._colladaExporter = this._colladaExporter || new ColladaExporter.ColladaExporter();
...
//# sourceMappingURL=URDFExporter.js.map
